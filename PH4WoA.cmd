...
ECHO %GO% "wget -q https://raw.githubusercontent.com/DesktopECHO/Pi-Hole-for-WOA/main/gs4wsl1 -O /usr/local/bin/gs4wsl1 ; chmod +x /usr/local/bin/gs4wsl1 ; gs4wsl1"  >> "%PRGF%\Gravity Sync - Setup.cmd"
